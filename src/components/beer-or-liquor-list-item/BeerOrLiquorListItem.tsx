                    ...
                    <SelectMenu>
                        ...
                        <SelectMenu.Modal align='right'>
                            ...
                            <SelectMenu.List>
                                ...
                                <Link
                                    to={`/beer-or-liquor?id=${beerOrLiquor._id}`}
                                >
                    ...
                    >
                        ...
                        <Box p={3} pb={0}>
                            <Text letterSpacing={0.75}>
                                ...
                                {beerOrLiquor.name}? This will also delete any
                                mixed drinks where {beerOrLiquor.name} is an
                                ingredient.
                            </Text>
                        </Box>
                        <Flex justifyContent='flex-end' p={3} pt={2}>
                            ...
                            <ButtonDanger onClick={deleteRecord}>
                                Delete
                            </ButtonDanger>
                        </Flex>
                    </Dialog>
