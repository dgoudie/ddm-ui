...
import { displayErrorToast, useErrorToastEffect } from '../../utils/toast';
  ...
  return (
    <form className={styles.root} onSubmit={save}>
      ...
      <FormGroup>
        ...
        <Relative>
          <Details {...getTypeDetailsProps()} className={styles.details}>
            <Dropdown.Button>{capitalCase(type)}</Dropdown.Button>
            <Dropdown.Menu direction='se' className={styles.dropdown}>
      ...
      <FormGroup>
        ...
        <Relative>
          <Details {...getInStockDetailsProps()} className={styles.details}>
            <Dropdown.Button>{inStock ? 'Yes' : 'No'}</Dropdown.Button>
            <Dropdown.Menu direction='se' className={styles.dropdown}>
              <Dropdown.Item
